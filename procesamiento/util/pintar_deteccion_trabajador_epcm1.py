...
def pintar_deteccion_trabajador(zona_prohibida_1,zona_prohibida_2,enviar_alerta,telegram_url,chat_id,ruta_factores,ruta_no_factores):
            ...
            def on_next(json_datos):
                ...
                for box in boxes:
                    for zona in zona_prohibida_1:
                        ...
                        #resultado=util_poligonos.box_dentro_poligono(555,363,689,515,zona)
                ...
                if img_con_alerta_zona1 or img_con_alerta_zona2:
                    ...
                    json_datos["mensaje"] = "EPCM1 Trabajador en Zona Prohibida " + str(json_datos["involucrados"]) + " involucrados"
